...
async function main() {
    console.log('🚀 Starting Tier Guardrail Verification...');
    ...
    // Try adding a 3rd member (should fail in API, but let's check logic)
    ...
    console.log(`✅ Created ELITE group: ${eliteGroup.name} (Limit: ${eliteGroup.maxMembers})`);

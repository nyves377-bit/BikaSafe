...
const LoanRequestModal: React.FC<ModalProps & { members: any[], user: any }> = ({ onClose, onSuccess, members, user }) => {
    const [amount, setAmount] = useState('');
...
const AnnouncementModal: React.FC<{ onClose: () => void; onSuccess: (a: any) => void }> = ({ onClose, onSuccess }) => {
...
const MeetingModal: React.FC<{ members: any[], onClose: () => void; onSuccess: () => void }> = ({ members, onClose, onSuccess }) => {
    const [title, setTitle] = useState('');
...
const PollModal: React.FC<{ onClose: () => void; onSuccess: () => void }> = ({ onClose, onSuccess }) => {
    const [title, setTitle] = useState('');
    const [description, setDescription] = useState('');
    const [loading, setLoading] = useState(false);
    const [error, setError] = useState('');
